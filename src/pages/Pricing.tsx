...
const DEFAULT_PLANS: SubscriptionPlan[] = [
  {
    ...
    amount: 0.01,
    interval: 'monthly',
    features: ['2 Payment Links', 'Free payment type only', 'Basic analytics', 'No platform fee', 'Community support'],
    is_active: true,
  },
  {
    id: '2',
    ...
    amount: 10,
    interval: 'monthly',
    features: ['10 Payment Links', 'Free + One-time payments', 'Basic analytics', '2% platform fee (for maintenance & future features)', 'Email support'],
    is_active: true,
  },
  {
    id: '3',
    ...
    amount: 20,
    interval: 'monthly',
    features: ['25 Payment Links', 'Advanced analytics', '1% platform fee (for maintenance & future features)', 'Priority support', 'Custom branding', 'Tracking links'],
    is_active: true,
  },
  {
    id: '4',
    ...
    amount: 30,
    interval: 'monthly',
    features: ['35 Payment Links', 'Advanced analytics', '1% platform fee (for maintenance & future features)', 'Priority support', 'Custom branding', 'Tracking links'],
    is_active: true,
  },
  {
    id: '5',
    ...
    amount: 50,
    interval: 'monthly',
    features: ['55 Payment Links', 'Advanced analytics', '0.75% platform fee (for maintenance & future features)', 'Priority support', 'Custom branding', 'Tracking links'],
    is_active: true,
  },
  {
    id: '6',
    ...
    amount: 100,
    interval: 'monthly',
    features: ['100 Payment Links', 'All payment types (Free + One-time + Recurring + Donations)', 'Full analytics suite', '2% platform fee (for maintenance & future features)', '24/7 Priority support', 'Custom integrations', 'Dedicated account manager'],
    is_active: true,
  },
];
